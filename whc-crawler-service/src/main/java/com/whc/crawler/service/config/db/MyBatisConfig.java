...
import com.whc.crawler.service.config.db.properties.PrimaryDataSourceProperties;
...
public class MyBatisConfig {
    ...
    public SqlSessionFactory primarySqlSessionFactory(
        ...
        try {
            ...
            readSqlSessionFactory.setTypeAliasesPackage("com.whc.crawler.service.*.domain.model");
